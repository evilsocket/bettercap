...
namespace :test do
  ...
  task :ssh_proxy do
    ...
    system( "clear && sudo bettercap -T 192.168.1.6 --no-discovery --tcp-proxy-upstream-address #{addr} --tcp-proxy-upstream-port 22 --tcp-proxy-module test_tcp_module.rb -D" )
  end
